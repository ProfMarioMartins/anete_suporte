...
">
  ...
  <span>ATENÇÃO: PLÁGIO</span>
</div>

<p>
  <strong>Plágio</strong> é o uso de ideias, trechos, dados ou produções intelectuais de outra pessoa sem a devida atribuição de autoria.
</p>

<p>
  Ele pode ocorrer tanto na <strong>cópia literal sem indicação da fonte</strong> quanto na <strong>reformulação de ideias alheias sem referência</strong>.
</p>
