...
Uma das principais formas de fazer uma paráfrase honesta é por meio das citações e referenciá-las adequadamente.

A escrita acadêmica exige rigor na apresentação das fontes de informação. As **normas de citação e referência** — como as da ABNT, APA ou Vancouver — cumprem um papel fundamental nesse processo: elas garantem a *padronização*, a *transparência* e a *credibilidade* do trabalho científico.
...
Trocar algumas palavras não transforma uma ideia alheia em ideia própria: mesmo reformulada, sua origem deve ser indicada.
:::
...
>Silva (2024) afirma que a competência argumentativa se desenvolve pelo contato sistemático com práticas de leitura e escrita.

No segundo exemplo, o texto informa explicitamente que a afirmação está sendo atribuída a outra pessoa.

Uma das maneiras de realizar essa atribuição é utilizar verbos dicendi.

::: enfase
**Verbo dicendi** é um verbo empregado para introduzir ou atribuir a outra pessoa uma fala, afirmação, interpretação ou posicionamento.

Na escrita acadêmica, esses verbos ajudam o leitor a identificar quem é responsável pela ideia apresentada.
...
A escolha do verbo também pode informar como o autor do texto interpreta a posição da fonte.
...
Esses verbos não são equivalentes. Afirmar, sugerir, defender e questionar apresentam diferentes formas de posicionamento.

::: callout-warning
⚠️ Atenção

O verbo escolhido deve ser compatível com aquilo que o autor citado efetivamente faz no texto original.

Não se deve escrever que um pesquisador “demonstra”, “defende” ou “critica” determinada ideia se a fonte não autoriza essa interpretação.
:::
