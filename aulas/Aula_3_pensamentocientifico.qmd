...
**Afinal, o que é Ciência?** (p. 9-12), **Um pouco de História e Filosofia da Ciência** (p. 8-14) e **Racionalidade científica: saindo do piloto automático** (p. 15-16), capítulos do livro *Afinal o que é ciência?... e o que não é*, de André Demambre Bacchi. Disponível na Minha Biblioteca.
...
```{=html}
<div id="carrossel-pensamento-cientifico"
  ...
  <div class="carousel-inner carrossel-slides">
    ...
    <div class="carousel-item active">
      <div class="carrossel-slide-conteudo carrossel-slide-inicial">
  ...
  <div class="carrossel-navegacao">
    ...
    <button class="carrossel-botao"
            type="button"
            data-bs-target="#carrossel-pensamento-cientifico"
            data-bs-slide="prev">
      ‹ Anterior
    </button>
    ...
    <div class="carrossel-indicadores">
      <button type="button"
              ...
              class="active"
              aria-current="true"
              aria-label="Tela 1"></button>

      <button type="button"
              data-bs-target="#carrossel-pensamento-cientifico"
              data-bs-slide-to="1"
              aria-label="Tela 2"></button>

      <button type="button"
              data-bs-target="#carrossel-pensamento-cientifico"
              data-bs-slide-to="2"
              aria-label="Tela 3"></button>

      <button type="button"
              data-bs-target="#carrossel-pensamento-cientifico"
              data-bs-slide-to="3"
              aria-label="Tela 4"></button>

      <button type="button"
              data-bs-target="#carrossel-pensamento-cientifico"
              data-bs-slide-to="4"
              aria-label="Tela 5"></button>

      <button type="button"
              data-bs-target="#carrossel-pensamento-cientifico"
              data-bs-slide-to="5"
              aria-label="Tela 6"></button>
    </div>
