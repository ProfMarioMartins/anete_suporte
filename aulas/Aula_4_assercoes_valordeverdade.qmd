...
- *distinguir possuir valor de verdade de conseguir determinar o valor de verdade de uma asserção.*
...
::: destaque
Você e sua parceira (ou parceiro) criaram um aplicativo que **conecta passageiros a pessoas que realizam viagens utilizando o próprio carro**.
...
| **Podemos determinar seu valor de verdade?** | *Sim: é verdadeira*; *sim: é falsa*; *não é possível determinar [atualmente]{.underline} se é verdadeira ou falsa*. |
  ...
  <div class="carousel-inner carrossel-slides">
    ...
    <div class="carousel-item">
      <div class="carrossel-slide-conteudo">
        ...
        <p class="carrossel-afirmacao">
          Salve o arquivo antes de fechar o programa.
        </p>
    ...
    <div class="carousel-item">
      <div class="carrossel-slide-conteudo">
        ...
        <p class="carrossel-afirmacao">
          Qual linguagem de programação você está aprendendo neste semestre?
        </p>
    ...
    <div class="carousel-item">
      <div class="carrossel-slide-conteudo">
        ...
        <p class="carrossel-afirmacao">
          Existe vida microbiana em algum planeta fora do Sistema Solar.
        </p>
...
3. Reconhecer que uma frase possui valor de verdade não significa saber se ela é verdadeira ou falsa. Analise as duas asserções abaixo.
...
<figure style="text-align: center;">
  <img src="/img/pokepu_obl.png" style="width:100%; display:block; margin:auto;" alt="Árvore de Pokémon híbridos" />
