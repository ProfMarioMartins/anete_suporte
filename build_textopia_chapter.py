...
def main():
    if len(sys.argv) != 2:
        raise SystemExit("usage: build_textopia_chapter.py OUTPUT.docx")
    ...
    configure_style(doc.styles["List Bullet"], 12, False, 0, 2)
    ...
    for index, block in enumerate(blocks):
        if index == 0:
            ...
            set_font(paragraph.add_run(block), 23, True)
